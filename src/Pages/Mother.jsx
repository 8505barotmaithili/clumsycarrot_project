...
//       <Navbar />
//       <hr></hr>
//       <h1 style={{ textAlign: "center" }}> Mothers day special</h1>
//       <div
//         style={{
//           height: "700px",
//           width: "90%",
...
//         <h1 style={{ textAlign: "center" }}>Our Best Gifts</h1>
//         <Giftsection />
//       </div>
//       <div
//         style={{
...
//           }}
//         >
//           <div style={{ height: "700px", width: "45%" }}>
//             <img
...
//           </div>
//           <div
//             style={{ height: "700px", width: "45%", backgroundColor: "purple" }}
//           >
//             <img
...
//   sophisticated basics or opulent styles, our men's gift selection makes
//   it easy to find the perfect present. From weekday looks by Ralph
//   Lauren to weekend vibes from Faherty, CREED fragrances to high-tech
//   kitchen tools, with options for every facet of his life our gifts
//   collection makes it easy to give him something truly unique. Gifts
//   Ideas for Kids. Give them joy-inducing gifts created just for them.
//   With baby booties and bikes, clothing and games, our collection
//   includes gifts from UGG®, Tender Leaf Toys, Wonder & Wise by Asweets,
//   and more, so you can treat your favorite little ones to a little extra
//   fun. Hosting & Housewarming Gifts. Thank them for hosting or help
//   celebrate their new space with covetable designs from Michael Aram,
//   NEST New York, Voluspa, and more. Featuring hosting and housewarming
//   gifts that are thoughtful and stylish, like photo frames that double
//   as works of art, scented candles to set a mood, and crystal tumblers
//   for cocktail hour, you'll find the perfect way to show your gratitude
//   and fête your friends. Luxe Gifts. For decadent gifts, turn to our
//   luxe collection. Curated to make indulging them simple, our selection
//   features undeniably chic gifts for women and men who appreciate
//   beautiful design at every level. And whether you choose LAGOS jewelry,
//   a Saint Laurent purse, Moncler jacket, or an objet d'art for their
//   home or office, you can give them something they'll cherish for years
//   to come. Gifts Under $100. Thoughtful, meaningful, and elevated gifts
//   can come at a range of price points, including under $100. Our edit of
//   sophisticated, affordable gift ideas features unexpectedly luxurious
//   options from brands like Longchamp, DIOR, Matouk, VIETRI, and more.
//   Explore the newest selection of inspired gifts under $100.
// </p>
//       </div>
//       <br></br>
//       <br></br>
